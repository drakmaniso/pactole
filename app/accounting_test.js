...
assert.throws(() => {
  _ = new acc.Transaction(new Date(), [], [])
})
assert.throws(() => {
  _ = new acc.Transaction(new Date(), [new acc.Debit(l.expenses, 33)], [])
})
assert.throws(() => {
  _ = new acc.Transaction(
    new Date(),
    [new acc.Debit(l.expenses, 22)],
